...
const _defaultWidget = BreathingAnimationWidget(
  ...
  circleScale: 1.0,
  circleOpacity: 1.0,
  circleBottomScale: 1.0,
  circleBottomOpacity: 1.0,
);

void main() {
  group('BreathingAnimationWidget', () {
    testWidgets('renders without error', (tester) async {
      await tester.pumpWidget(_wrap(const SizedBox(width: 120, child: _defaultWidget)));
    ...
    testWidgets('all circle params at 0.0 render without error', (tester) async {
      await tester.pumpWidget(_wrap(const SizedBox(
        width: 120,
        child: BreathingAnimationWidget(
          fillLevel: 1.0,
          ...
          circleScale: 0.0,
          circleOpacity: 0.0,
          circleBottomScale: 0.0,
          circleBottomOpacity: 0.0,
        ),
      )));
      expect(tester.takeException(), isNull);
    });
